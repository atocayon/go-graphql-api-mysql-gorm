...
func (ec *executionContext) field_Mutation_createOrder_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNOrderInput2githubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐOrderInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_updateOrder_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg1, err = ec.unmarshalNOrderInput2githubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐOrderInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNOrder2ᚖgithubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Order_items(ctx context.Context, field graphql.CollectedField, obj *model.Order) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNItem2ᚕᚖgithubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐItemᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_orders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Order)
	fc.Result = res
	return ec.marshalNOrder2ᚕᚖgithubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐOrderᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputOrderInput(ctx context.Context, obj interface{}) (model.OrderInput, error) {
	...
	for k, v := range asMap {
		...
		case "items":
			...
			it.Items, err = ec.unmarshalNItemInput2ᚕᚖgithubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐItemInputᚄ(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) marshalNItem2ᚕᚖgithubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐItemᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Item) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNItem2ᚖgithubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐItem(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNItem2ᚖgithubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐItem(ctx context.Context, sel ast.SelectionSet, v *model.Item) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalNItemInput2ᚕᚖgithubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐItemInputᚄ(ctx context.Context, v interface{}) ([]*model.ItemInput, error) {
	...
	for i := range vSlice {
		...
		res[i], err = ec.unmarshalNItemInput2ᚖgithubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐItemInput(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalNItemInput2ᚖgithubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐItemInput(ctx context.Context, v interface{}) (*model.ItemInput, error) {
	res, err := ec.unmarshalInputItemInput(ctx, v)
	return &res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNOrder2githubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v model.Order) graphql.Marshaler {
	return ec._Order(ctx, sel, &v)
}

func (ec *executionContext) marshalNOrder2ᚕᚖgithubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐOrderᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Order) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrder2ᚖgithubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNOrder2ᚖgithubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalNOrderInput2githubᚗcomᚋgoᚑgraphqlᚑapiᚑmysqlᚑgormᚋgraphᚋmodelᚐOrderInput(ctx context.Context, v interface{}) (model.OrderInput, error) {
